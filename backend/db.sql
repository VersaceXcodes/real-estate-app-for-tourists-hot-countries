...
UPDATE locations SET property_count = 2 WHERE location_id = 'loc_001';
UPDATE locations SET property_count = 1 WHERE location_id = 'loc_002';
UPDATE locations SET property_count = 1 WHERE location_id = 'loc_003';
UPDATE locations SET property_count = 1 WHERE location_id = 'loc_004';
UPDATE locations SET property_count = 1 WHERE location_id = 'loc_005';