...
-- Update property counts in locations
UPDATE locations SET property_count = 2 WHERE location_id = 'loc_001' AND property_count != 2;
UPDATE locations SET property_count = 1 WHERE location_id = 'loc_002' AND property_count != 1;
UPDATE locations SET property_count = 1 WHERE location_id = 'loc_003' AND property_count != 1;
UPDATE locations SET property_count = 1 WHERE location_id = 'loc_004' AND property_count != 1;
UPDATE locations SET property_count = 1 WHERE location_id = 'loc_005' AND property_count != 1;